...
import { setHeroVisibility } from '../../actions';

import './index.scss';

class HomeSection extends Component {
  _onChange = (isVisible) => {
    this.props.setHeroVisibility(isVisible);
  };

  render() {
    const { isMobile, loaded } = this.props;
...
HomeSection.propTypes = {
  ...
  setHeroVisibility: PropTypes.func.isRequired,
};
